...
async function runIndexing() {
  ...
  try {
    ...
    console.log("\n🤖 Menghubungi Gemini API untuk proses embedding massal...");
...
//     // =========================================================
//     // 🔢 SESI 2: VISUALISASI HASIL EMBEDDING (100 ANGKA PERTAMA)
//     // =========================================================
//     console.log("\n=================================================");
//     console.log(" 🔢 SESI 2: VISUALISASI HASIL EMBEDDING (100 ANGKA) ");
//     console.log("=================================================");

//     storageData.forEach((item, index) => {
//       console.log(`\n[EMBEDDING VECTOR CHUNK KE-${index + 1}]`);
//       console.log(
//         `📍 Koordinat Vektor (100 angka pertama): \n[${item.embedding.slice(0, 100).join(", ")} ...]`,
//       );
//       console.log("-------------------------------------------------");
//     });
...
//     // --- FASE 3: SAVE / REPLACE FILE KE DISK ---
//     // Di file JSON asli, seluruh data embedding tetap tersimpan utuh (768 angka)
//     await fs.writeFile(
//       outputPath,
//       JSON.stringify(storageData, null, 2),
//       "utf-8",
